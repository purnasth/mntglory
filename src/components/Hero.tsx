...
const Hero = () => {
  return (
    <>
      <main className="md:px-6 pt-6">
        <section className="grid grid-cols-1 gap-4 lg:gap-6 lg:grid-cols-5">
          ...
          <aside className="col-span-4">
            <div className="md:mb-3 grid grid-cols-2 gap-6 md:grid-cols-4 lg:gap-0">
              ...
              <div className="relative z-10 col-span-2 my-0">
                ...
                <div className="hidden md:block inset-0 size-full h-auto min-h-40 max-w-xs content-end md:ml-auto lg:absolute lg:mx-auto lg:translate-y-8">
                  <TeamUI />
                </div>
              </div>
            </div>
        ...
        <section className="mt-6 grid grid-cols-1 gap-4 lg:gap-6 lg:grid-cols-9">
