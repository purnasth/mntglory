...
const Events: React.FC = () => {
  ...
  return (
    <main className="border-y border-dark/20 bg-light">
      <div className="grid grid-cols-1 gap-y-10 sm:gap-y-16 lg:grid-cols-3 lg:gap-16">
        <div className="top-32 space-y-4 text-dark lg:sticky lg:col-span-1 lg:max-h-fit">
          {/* <span className="text-sm uppercase opacity-60 md:text-base">
            What we do
          </span> */}
          <h3 className="text-4xl md:text-6xl">Latest Events</h3>
          <p className="text-pretty text-sm opacity-70 md:text-base">
          ...
          <div className="flex items-center gap-16 md:pt-5 lg:justify-between">
            <div className="flex flex-col items-center gap-2 md:gap-4">
              <h5 className="text-xl md:text-3xl font-semibold">100%</h5>
          ...
          <div>
            <Link
              to="/events"
              className={`transition-300 group mt-8 md:mt-12 flex w-max items-center gap-2 rounded-lg border border-dark bg-dark px-5 py-2 text-base text-light hover:bg-dark/20 hover:text-dark md:text-base`}
              aria-label="Events"
            >
              View all events
          ...
          {eventsContents &&
            eventsContents.map((service, index) => (
              ...
              >
                ...
                <div className="space-y-2 p-5 md:space-y-5 md:p-10">
                  <h5 className="font-body text-xl sm:text-2xl capitalize md:text-4xl">
                    {service.title}
                  </h5>
                  <p className="text-pretty text-sm text-justify md:text-left opacity-80 md:text-base">
                    {service.content}
                  </p>
                </div>
              </div>
